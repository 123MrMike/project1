...
st.write("Here we've compared the cars price against the model year. Newer cars populate the majority of the data points. There is a positive correlation between new cars and higher prices.We can also")
st.write(" point out the extreme outliers. that threw off the average disrtibution in the previous Histogram. Some overpriced cars from the late 90's to early 2000's (perhaps vintage collectables) are")
st.write(" skewing the entire visual to the far outskirts of $100,000 and greater price range, when in fact the majority of the data is in the $80,000 and lower range.")
...
st.write("A better Statistical model would be the IQR (Inter Quartile Range), which is the difference between the 1st and 3rd quartile. A quartile is a marker for")
st.write("a quarter of the data points. The Median is the middle data point in our data set, meanwhile IQR marks the range for the middle 50 percent of the data")
...
st.write("Which means the middle 50 percent of the cars in our data set are *actually* around the $15,000 range, with a Median of $13,500. This statistical analysis is a great way to factor out extreme outliers.")